...
public class RoverRuckusCraterAutonomousPassiveDefenseProgram extends LinearOpMode {
    ...
    final int extensionDrivePosition = 100, intakeIntakePosition = 310;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        mineral_rotation.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        mineral_rotation.setTargetPosition(-450);
        mineral_rotation.setPower(0.6);

        drive.softResetEncoder();
        while(opModeIsActive() && drive.move(drive.getEncoderDistance(), 23*COUNTS_PER_INCH, 20 *COUNTS_PER_INCH,
                0, 25*COUNTS_PER_INCH, DEFAULT_MAX_POWER, DEFAULT_MIN_POWER, -45 , DEFAULT_PID, -45
                ,1*COUNTS_PER_INCH, 0)){
            globalCoordinatePositionUpdate();
        ...
        while (opModeIsActive() && drive.pivot(0, -25, 0.75, 0.15,
        ...
        drive.softResetEncoder();
        while(opModeIsActive() && drive.move(drive.getEncoderDistance(), 80*COUNTS_PER_INCH, 70*COUNTS_PER_INCH,
                0, 80*COUNTS_PER_INCH, DEFAULT_MAX_POWER, DEFAULT_MIN_POWER, 0 , DEFAULT_PID, 0
                ,1*COUNTS_PER_INCH, 0)){
            globalCoordinatePositionUpdate();
        }
        drive.stop();
        ...
        while (opModeIsActive() && drive.pivot(-135, 0, 0.75, 0.15,
                500, 5, Direction.COUNTERCLOCKWISE)){
            globalCoordinatePositionUpdate();
            telemetry.update();
        }
        drive.stop();
        ...
        drive.softResetEncoder();
        while(opModeIsActive() && drive.move(drive.getEncoderDistance(), 4*COUNTS_PER_INCH, 3 *COUNTS_PER_INCH,
                0, 4*COUNTS_PER_INCH, DEFAULT_MAX_POWER, DEFAULT_MIN_POWER, -45 , DEFAULT_PID, -135
                ,1*COUNTS_PER_INCH, 0)){
            globalCoordinatePositionUpdate();
            telemetry.addData("Distance", drive.getEncoderDistance()/COUNTS_PER_INCH);
            telemetry.update();
        ...
        drive.softResetEncoder();
        while(opModeIsActive() && drive.move(drive.getEncoderDistance(), 10*COUNTS_PER_INCH, 8 *COUNTS_PER_INCH,
                0, 10*COUNTS_PER_INCH, DEFAULT_MAX_POWER, DEFAULT_MIN_POWER, -135 , DEFAULT_PID, -135
                ,1*COUNTS_PER_INCH, 0)){
            globalCoordinatePositionUpdate();
            telemetry.addData("Distance", drive.getEncoderDistance()/COUNTS_PER_INCH);
            telemetry.update();
        ...
        //Pivot to face crater
        while (opModeIsActive() && drive.pivot(45, 180, 0.75, 0.15,
                500, 5, Direction.FASTEST)){
            globalCoordinatePositionUpdate();
            telemetry.update();
        }
        ...
        //Extend arm to park in crater and deploy intake to get minerals
        intakeRotation.setTargetPosition(intakeIntakePosition);
    ...
    public void scanMineralAndDelatch(){
        ...
        mineralExtension.setPower(1);
        mineral_rotation.setTargetPosition(125);
